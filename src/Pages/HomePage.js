          ...
          <div class="animation-area">
            <div className="home-main">
              <p class="section-subtitle">
                Welcome To IDEN CENTRE FOR THE ONLINE LEARNING
              </p>
            ...
            <div className="container">
              <nav className="course-nav">
                <div className="navbtn-group">
                  <button
                    className="navbtn-group__item active"
                    onClick={() => {
                      FilterItems("web-development");
                    }}
                  >
                    Web-Development
                  </button>
                  <button
                    className="navbtn-group__item"
                    onClick={() => {
                      FilterItems("mobile-development");
                    }}
                  >
                    Mobile-Development
                  </button>
                  ...
                  <>
                    <div class="course-card">
                      <div class="course-content">
                        ...
                        <Link to={"/singleservice/" + service.service_title}>
                          {" "}
            ...
            <div class="testimonials-right">
              <div class="testimonials-card">
                ...
                <p class="testimonials-text">
                  ...
                  elementum. Ut mollis leo odio vulputate rutrum. Nunc sagittis
                  sit amet ligula ut eleifend. Mauris consequat mauris sit amet
                  turpis commodo fermentum. Quisque consequat tortor ut nisl
                  finibus".
                </p>
